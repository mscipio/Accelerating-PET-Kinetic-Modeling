function [x,jacobian,resnorm,residual,exitflag,output,lambda] = fit_nl(model, x0, xdata, ydata, fixed, lb, ub, opt)
...
[x,resnorm,residual,exitflag,output,lambda,jacobian] = lsqcurvefit(@F, x0, xdata, ydata, lb, ub, opt);
